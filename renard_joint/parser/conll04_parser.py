...
# Constants
TRAIN_PATH = os.path.join(os.environ.get("DATA", "data"), "CoNLL04/train.txt")
DEV_PATH = os.path.join(os.environ.get("DATA", "data"), "CoNLL04/dev.txt")
TEST_PATH = os.path.join(os.environ.get("DATA", "data"), "CoNLL04/test.txt")
UNK_TOKEN = 100
CLS_TOKEN = 101
SEP_TOKEN = 102
